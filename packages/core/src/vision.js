...
class VisionAnalyser {
    ...
    async analyse(currentScreenshotPath, baselinePath, outputDir) {
    ...
    // ── AI Vision Analysis ────────────────────────
    async analyseFirstRunWithVision(currentPath, baselinePath) {
    ...
    async analyseWithVision(currentPath, baselinePath, outputDir) {
    ...
    // ── Pixel Diff Fallback ───────────────────────
    async analyseWithPixelDiff(currentPath, baselinePath, outputDir) {
...
exports.VisionAnalyser = VisionAnalyser;
// ── Helpers ───────────────────────────────────
...
async function buildSideBySide(left, right) {
    try {
