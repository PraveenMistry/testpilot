...
import { LLMInterface, TestPlan, TestStep, Platform } from './types';
...
function buildPlannerPrompt(goal: string, baseUrl: string, context?: string): string {
...
function normaliseSteps(steps: any[]): TestStep[] {
